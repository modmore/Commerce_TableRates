    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_INSTALL:
            ...
            if ($commerce instanceof Commerce) {
                ...
                $basePath = $modx->getOption('core_path') . 'components/commerce_tablerates/';
                ...
                $commerce->loadModulesFromDirectory($modulePath, 'modmore\\CommerceTableRates\\Modules\\', $modulePath);
